...
public class AccountDAOImpl implements AccountDAO {
    ...
    public static final String getAccountByUsername="SELECT" +
            " SIGNON.USERNAME," +
            "ACCOUNT.EMAIL," +
            "ACCOUNT.FIRSTNAME," +
            "ACCOUNT.LASTNAME," +
    ...
    public static final String getAccountByUsernameAndPassword="SELECT" +
            " SIGNON.USERNAME," +
            "ACCOUNT.EMAIL," +
            "ACCOUNT.FIRSTNAME," +
            "ACCOUNT.LASTNAME," +
    ...
    public static final String updateAccount="UPDATE ACCOUNT SET" +
            " EMAIL = ?," +
            "FIRSTNAME = ?," +
            "LASTNAME = ?," +
            "STATUS = ?," +
    ...
    public static final String insertAccount="INSERT INTO ACCOUNT (EMAIL, FIRSTNAME, LASTNAME, STATUS, ADDR1, ADDR2, CITY, STATE, ZIP, COUNTRY, PHONE, USERID) VALUES (?, ?, ?, ?, ?,  ?, ?, ?, ?, ?, ?, ?)";

    public static final String updateProfile="UPDATE PROFILE SET" +
            " LANGPREF = ?," +
            "FAVCATEGORY = ?" +
            " WHERE USERID = ?";

    public static final String insertProfile="INSERT INTO PROFILE (LANGPREF, FAVCATEGORY, USERID)" +
            " VALUES (?, ?, ?)";

    public static final String updateSignon="UPDATE SIGNON SET PASSWORD = ?" +
            " WHERE USERNAME = ?";

    public static final String insertSignon="INSERT INTO SIGNON (PASSWORD,USERNAME)" +
            " VALUES (?, ?)";
