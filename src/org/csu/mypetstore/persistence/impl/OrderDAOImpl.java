...
public class OrderDAOImpl implements OrderDAO {
    ...
    private static final String getOrderId="select num from test";
    private static final String setOrderId="update test set num= ? + 1 where num = ?";
    ...
    public void insertOrder(Order order) {
        try {
            ...
            Timestamp t = new Timestamp(order.getOrderDate().getTime());
    ...
    public void setOrderId(Order order) {
        try {
            Connection connection = DBUtil.getConnection();
            PreparedStatement preparedStatement1 = connection.prepareStatement(getOrderId);
            ...
            if (resultSet.next()){
                ...
                PreparedStatement preparedStatement = connection.prepareStatement(setOrderId);
                preparedStatement.setInt(1,orderId);
