...
public class ItemDAOImpl implements ItemDAO {
    ...
    public static final String getItem="select" +
            " I.ITEMID," +
            "LISTPRICE," +
            "UNITCOST," +
            ...
            " and I.ITEMID = ?";
    public static final String getInventoryQuantity="SELECT QTY AS value FROM INVENTORY WHERE ITEMID = ?";
    public static final String updateInventoryQuantity="UPDATE INVENTORY SET QTY = QTY - ? WHERE ITEMID = ?";
